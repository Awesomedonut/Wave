...
public class WavePlatformTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<WavePlatformTenantDatabaseMigrationHandler> _logger;

    public WavePlatformTenantDatabaseMigrationHandler(
        WavePlatformDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<WavePlatformTenantDatabaseMigrationHandler> logger)
    {
